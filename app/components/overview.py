        ...
        rx.el.div(
            ...
            rx.el.div(
                ...
                rx.el.span(
                    ...
                    "а внатре во секој извор редот е по реална сигурност.",
    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.p(
                    f"Вчитано во {OverviewState.generated_at} · BZZ покриеност: денес и утре · {OverviewState.total_picks} избори · {OverviewState.bzz_pick_count} BZZ · {OverviewState.fotmob_pick_count} Fotmob · {OverviewState.mutating_pick_count} Mutating · {OverviewState.missing_predictions} настани без предвидување",
        ...
        rx.el.div(
            rx.el.div(
                section_card(
                    "Најсигурни избори",
                    "Наизменично мешани извори: BZZ, Fotmob и Mutating",
                    "star",
                    top_picks(),
                ),
                class_name="flex-1 min-w-0",
